            ...
            myRef.orderByChild("Day").equalTo(createDay).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        textSearchEventType.setText("There are no events on this day");
                        textSearchEventName.setText("");
                        textSearchEventTime.setText("");
                        textSearchEventDate.setText("");
                        textSearchDescription.setText("");
                        textSearchEventAddresss.setText("");
                    }
